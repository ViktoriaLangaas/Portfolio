...
export default function ProjectDetail() {
      ...
      <main className="min-h-screen p-8 bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">
            {language === "en" ? "Project not found" : "Prosjekt ikke funnet"}
          </h2>

          <p className="mb-4">
            {language === "en"
              ? "Sorry, we could not locate that project."
              : "Kunne ikke finne prosjektet."}
          </p>
  ...
  const localizedFeatures = project.features[language];
  const localizedTimeFrame = project.timeFrame[language];
      ...
      <div className="mx-auto max-w-6xl p-4 sm:p-8">
        ...
        <div className="rounded-3xl border border-gray-200/60 dark:border-gray-700/70 bg-white/95 dark:bg-gray-900/80 shadow-2xl overflow-hidden">
          ...
          <div className="p-6 sm:p-8">
            ...
            <p className="text-slate-700 dark:text-white/90 mb-1 text-lg md:text-xl">
              {localizedTimeFrame}
            </p>

            <p className="text-slate-600 dark:text-blue-200 mb-4 text-sm md:text-base">
              {localized.course}
            </p>
            ...
            <div className="rounded-2xl bg-gray-100 dark:bg-gray-900 p-5">
              <p className="mb-4 text-base leading-relaxed text-gray-700 dark:text-gray-200">
                {localized.longDescription}
              </p>

              <p className="mb-8 text-base font-medium leading-relaxed text-gray-700 dark:text-gray-200">
                {localized.moreText}
              </p>
              ...
              <section className="mb-8">
                ...
                <ul className="grid gap-2 md:grid-cols-2 list-none">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.technologies.map((tech) => (
                    <Badge
                      key={tech}
                      variant="default"
                      className="bg-gray-200 dark:bg-blue-900 text-gray-800 dark:text-white"
                    >
                      {tech}
                    </Badge>
                  ))}
                  ...
                  {project.extraImages.length === 0 ? (
                    <div className="text-sm text-gray-600 dark:text-gray-300">
                      {language === "en"
                        ...
                        : "Ingen galleri-bilder tilgjengelig"}
                    </div>
                  ) : (
